...
non-local guesses:
	 -org/apache/spark/sql/types/spark/sparkContext/setLogLevel.
	 -org/apache/spark/sql/types/spark/sparkContext/setLogLevel#
	 -org/apache/spark/sql/types/spark/sparkContext/setLogLevel().
	 -spark/implicits/spark/sparkContext/setLogLevel.
	 -spark/implicits/spark/sparkContext/setLogLevel#
	 -spark/implicits/spark/sparkContext/setLogLevel().
	 -spark/sparkContext/setLogLevel.
	 -spark/sparkContext/setLogLevel#
	 -spark/sparkContext/setLogLevel().
	 -scala/Predef.spark.sparkContext.setLogLevel.
	 -scala/Predef.spark.sparkContext.setLogLevel#
	 -scala/Predef.spark.sparkContext.setLogLevel().
offset: 981
...
object S02_SparkSQL {
  ...
  def main(args: Array[String]): Unit = {
    ...
    spark.sparkContext.se@@tLogLevel("WARN")
