file://<WORKSPACE>/src/main/scala/spark/S01_RDDBasics.scala
...
non-local guesses:
	 ...
	 -SparkConf#
	 -scala/Predef.SparkConf#
offset: 528
uri: file://<WORKSPACE>/src/main/scala/spark/S01_RDDBasics.scala
text:
```scala
package spark
...
object S01_RDDBasics {
  ...
  def main(args: Array[String]): Unit = {
    ...
    try {
      ...
      // 方式3：从数组创建
      val wordsRDD = sc.parallelize(Array("hello", "world", "spark", "scala"))
